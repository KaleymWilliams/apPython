...
# You function should then print the result. result of my function would be (9+38j)
...
(s)elect a floor, (f)ire alarm (q)uit 
enter S, F,  or q === x
...
Append cause it useful when using a single item needs to be inserted.
...
answer9='your answer here' A function  is are like take in data and a function that can be used over and over again.
